...
public class ResponseHandler {
     ...
     * sale to the user via {@link BillingService#requestPurchase(String, String)}. The BillingService calls
     ...
     * handled in {@link Security#verifyPurchase(android.content.Context, String, String)}.
     * 
     * @param context
     *            the context
     * @param request
