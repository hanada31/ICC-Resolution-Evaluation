...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    public void setRefreshActionItemState(boolean refreshing, int menuItemResId) {
        View refreshButton = mActivity.findViewById(menuItemResId);
     ...
     * {@link eu.vranckaert.worktime.utils.view.actionbar.ActionBarHelperBase#setRefreshActionItemState(boolean, int)}.
     */
