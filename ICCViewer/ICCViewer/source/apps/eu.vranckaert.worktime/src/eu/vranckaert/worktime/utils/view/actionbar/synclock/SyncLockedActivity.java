 ...
 * Time: 15:16
 */
public abstract class SyncLockedActivity extends ActionBarGuiceActivity {
    ...
    private class SyncCheck extends AsyncTask<Void, Void, Void> {
        ...
        protected void onProgressUpdate(Void... values) {
            if (!isLocking) {
                isLocking = true;
                startActivityForResult(new Intent(SyncLockedActivity.this, SyncLockingActivity.class), Constants.IntentRequestCodes.SYNC_BLOCKING_ACTIVITY);
                this.cancel(true);
            }
        }
    }
