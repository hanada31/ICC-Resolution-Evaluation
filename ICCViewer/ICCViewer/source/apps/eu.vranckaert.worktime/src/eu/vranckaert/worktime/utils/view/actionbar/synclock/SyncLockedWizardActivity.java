 ...
 * Time: 15:33
 */
public abstract class SyncLockedWizardActivity extends WizardActivity {
    ...
    private class SyncCheck extends AsyncTask<Void, Void, Void> {
        ...
        protected void onProgressUpdate(Void... values) {
            if (!isLocking) {
                isLocking = true;
                startActivityForResult(new Intent(SyncLockedWizardActivity.this, SyncLockingActivity.class), Constants.IntentRequestCodes.SYNC_BLOCKING_ACTIVITY);
                this.cancel(true);
            }
        }
    }
